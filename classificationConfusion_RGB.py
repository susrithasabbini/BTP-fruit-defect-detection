...
# Function to plot confusion matrices with larger font size
def plot_confusion_matrices(cm, title):
    plt.figure(figsize=(8, 6))
    sns.set(font_scale=1.5)  # Increase font scale
    sns.heatmap(cm, annot=True, fmt='d', cmap='Blues', cbar=False, annot_kws={"size": 23})  # Larger annotation
...
plot_confusion_matrices(confusion_matrices["LDA"], title="LDA Confusion Matrix for RGB images")
